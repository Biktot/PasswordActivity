      ...
      await interaction.guild.members
        ...
        .then((fetchedMembers) => {
                ...
                datasets: [
                  {
                    ...
                    backgroundColor: [
                      ...
                      "#ED4245",
                      "#404040",
                    ], // convent the hex color to rgba to make it transparent
                    borderColor: [
                      "#5865F2",
                      "#57F287",
                      "#FEE75C",
                      "#ED4245",
                      "#404040",
                    ], // you can change the color according to the color you want
          ...
          interaction.editReply({
            files: [
              { attachment: String.raw`chart.png`, name: "member-count.png" },
            ],
          });
        });
    } catch (err) {
